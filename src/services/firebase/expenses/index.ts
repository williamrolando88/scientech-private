...
import { docReferencer, previousProjectReferencer } from '@src/services/firebase/expenses/docReferencer';
import { ExpenseParserByType } from '@src/services/firebase/expenses/parsers';
import { DB } from '@src/settings/firebase';
import { DayBookTransactionDetailOld, DayBookTransactionOld } from '@src/types/dayBook';
import { ExpenseOld, ExpenseTypeValuesOld, ExtendedGeneralExpenseOld, GeneralExpenseOld } from '@src/types/expenses';
      ...
      if (previousProjectDoc) {
        ...
        previousProject.received_vouchers =
          previousProject.received_vouchers.filter(
            (voucher: { id: string; }) => voucher.id !== expenseDocRef.id,
          );
      }
